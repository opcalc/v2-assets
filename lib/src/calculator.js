...
function renderGraph(graphData, t_no){
 ...
 /* <p>Figures are "+
  ...
  output += "<div style='display: flex; margin-top: 5px'>"+
    ...
    '   <div>'+
    '     $<input data-app-inputset="priceRange" placeholder="auto" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" type="tel" '+
    ...
    '     &hyphen;<input data-app-inputset="priceRange" placeholder="auto" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" type="tel" '+
