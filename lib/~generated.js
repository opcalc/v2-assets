...
document.cookie=c_name + "=" + c_value + "; domain="+(COOKIE_DOMAIN || '')
}
...
function newTab_return(reqData, data){
  if (data['strat-info'] != undefined && data['strat-info']['text'] != undefined){
	...
	$('#calcs_holder').append("<div class=\"jq_exclusive_target stratContent\" id=\"strat_"+data['tabId']+"\" name=\"strat_tabs\">"+data['code']+
