...
function getSummary(results){
  ...
  if (typeof(filteredRaxRiskTime) == 'object' && filteredRaxRiskTime instanceof Array)
    var maxRiskDays = ' on days '+descNumList(filteredRaxRiskTime);
  else if (filteredRaxRiskTime == noDays)
    var maxRiskDays = '';
  else if (filteredRaxRiskTime !== undefined)
