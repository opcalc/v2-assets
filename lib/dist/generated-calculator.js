...
function getSharingCode(tab_num){
  ...
  <div class='shareMenu'>\n\
    ...
    or <a href='#' onclick='loadShare({type:\"link\", tab_num:"+tab_num+", link_ele:this}); return false;' title='Short-link' class='link subtle'>Get short-link to share</a>\n\
  </div>\n\
...
function getSummary(results){
  ...
  var beExpString = implode(", ", (results.breakeven[i] || []).map(formatPrice));
