...
function renderGraph(graphData, t_no){
  ...
  pre += "<div style='display: flex; margin-top: 5px'>"+
  ...
  "     style='width: 40px; position: relative; z-index: 10;'"+
  "     name='ivChange' id='t"+t_no+"-ivChange' />"+
  "   <div class='id--ivChangePanel card' "+
  "     style='position: absolute; top: -0.2rem; left: -0.3rem; padding: 2.9em 0.3rem 0.3rem; min-width: 4.2em; z-index: 3'"+
  "   >"+ 
  '     <div id="t'+t_no+'_ivSlider">'+
  '       <div id="t'+t_no+'_ivSlider_custom-handle" class="ui-slider-handle"></div>'+
  '     </div>'+
  "     <a href='javascript:void' onclick='ivChangeUpdate("+t_no+")' style='padding: 0.2em 0; text-decoration: none'>"+
  "        "+
  "       <span style='text-decoration: underline'>Update IV</span>"+
...
function getSummary(results){
  ...
  var maxRoRString = mPRoiAnnDesc === null || s.maxprofit.g === 'u' ? null
