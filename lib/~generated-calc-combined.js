...
function getSummary(results){
  ...
  var maxRiskString = (s.maxrisk.g == 'u' ? 'infinite on upside' :
    (s.maxrisk.p == 'i' ? formatPrice(Math.abs(s.maxrisk.g + results.initial.g)) + ' on upside' : 
  ...
  var maxProfitString = (s.maxprofit.g == 'u' ? 'infinite on upside' :
    (s.maxprofit.p == 'i' ? formatPrice(Math.abs(s.maxprofit.g + results.initial.g)) + ' on upside' : 
  ...
  var summary =
    ...
    (hasPop ? "<p>Probability of profit: "+popString+" <a href='#' onclick='alert(\"Probability of returning profit at the time of expiry.  This figure is derived from 30 day Implied Volatility.\");return false;' class='help'>?</a></p>" : "");
